  ...
  <footer>
    <div id="footer_content">
      ...
      <ul class="footer-list">
        ...
        <li>
          <a href="teste2/teste2.html" class="footer-link">teste</a>
        </li>
        <li>
          <a href="tela2fa.html" class="footer-link">2FA</a>
      ...
      <ul class="footer-list">
        ...
        <li>
          <a href="equipamentos/equipamentos.html" class="footer-link">equipamentos</a>
        </li>
